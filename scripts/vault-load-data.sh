...
vault kv put secret/h2-data-service private.pseudo.property="private property value loaded from vault for h2-data-service"
...
vault kv get secret/h2-data-service
